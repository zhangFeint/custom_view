...
public class FlowLayout extends ViewGroup {
    ...
    //    控件边距
    private int left = 10, top = 10, right = 10, bottom = 10;
     ...
     * @param bottom
     */
    public void setBackGauge(int left, int top, int right, int bottom) {
        this.left = left;
        this.top = top;
        this.right = right;
        this.bottom = bottom;
    ...
    /**
     * 设置数据setData(SearchDao.getInstance().queryData(tempName),R.layout.flowlayout_textview);
     * @param strings
     * @param layout
     */
    public void setData(String[] strings, int layout) {
        int count = strings.length;
        for (int i = 0; i < count; i++) {
            final TextView tv = (TextView) mInflater.inflate(layout, this, false);
            tv.setText(strings[i]);
            tv.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (onTagClickListener != null)
                        onTagClickListener.TagClick(tv);
                }
            });
     ...
     * @param layout
     */
    public void setListData(List<String> list, int layout) {
        int count = list.size();
        for (int i = 0; i < count; i++) {
            final TextView tv = (TextView) mInflater.inflate(layout, this, false);
     ...
     * @param layout
     */
    public void addTag(String text, int layout) {
        final TextView tv = (TextView) mInflater.inflate(layout, this, false);
        tv.setText(text);
        tv.setOnClickListener(new OnClickListener() {
            @Override
...
//        Log.i("test", "sizeHeight" + sizeHeight);
        ...
        setPadding(dp2px(left), dp2px(top), dp2px(right), dp2px(bottom));
    }
    ...
    public interface OnTagClickListener {
        void TagClick(TextView textview);
    }
}